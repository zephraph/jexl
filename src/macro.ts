...
export function expand(expr: Expression, macros: Map<string, Macro>): Expression {
...
export function substitute(expr: Expression, bindings: Map<string, Expression>): Expression {
  ...
  if (typeof expr === "object" && expr !== null) {
    if ("ref" in expr && typeof expr.ref === "string" && bindings.has(expr.ref)) {
      return bindings.get(expr.ref)!;
    }
